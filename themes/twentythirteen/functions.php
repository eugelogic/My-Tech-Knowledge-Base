...
// Make the Snippet CPT posts show up on the blog pages
...
// Show posts of 'post', 'page' and 'snippet' post types on search results page.
...
// 	}
// }
// add_filter( 'pre_get_posts', 'add_cpt_to_archive' );
